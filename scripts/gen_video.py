...
train_list=["2013_05_28_drive_0002_sync",
...
for data_path in train_list:
    ...
    os.system("rm -r temp/{}".format(data_path))
    os.mkdir("temp/{}".format(data_path))
    ...
    for im1, im2 in tqdm(zip(files_1, files_2), total=len(files_1)):
        ...
        cv2.imwrite('temp/{}/{:06}.png'.format(data_path, count), im_h)
        count+=1
    os.system('ffmpeg -i temp/{}/%06d.png -vcodec libx264 -pix_fmt yuv420p {}_video.mp4'.format(data_path, data_path))